package com.mkdika.cloudblog.post.controller.resource;
...
/**
 *
 * This class is fork from
 * https://github.com/acogoluegnes/hateoas/blob/master/src/main/java/com/zenika/web/PageResource.java
 */
public class PageResource<T> extends ResourceSupport implements Page<T> {
    ...
    public <S> Page<S> map(Converter<? super T, ? extends S> cnvrtr) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.super
    }
